  ...
  return (
    <div className="fixed overflow-hidden top-0 w-0 sm:w-20 lg:w-56 flex flex-col border max-h-screen h-screen pt-6 pb-6 ">
      ...
      <div className="flex flex-col relative mt-4 gap-4 text-sm ml-2 flex-1 sm:items-center">
        ...
        <div
          className="flex flex-row w-11/12 h-10 bg-white hover:bg-slate-100 cursor-pointer items-center rounded-lg gap-3 group sm:justify-center md:justify-start"
          onClick={() => {
